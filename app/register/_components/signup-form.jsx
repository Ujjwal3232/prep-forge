...
export function SignupForm({ role }) {
  ...
  async function onSubmit(event) {
    ...
    try {
      ...
      response.status === 201 && router.push("/login");//this means user created successfully
    } catch (e) {
  ...
  return (
    <Card className="mx-auto max-w-sm bg-slate-900 border border-slate-800 hover:bg-slate-800 transition-colors duration-300">
      <CardHeader>
