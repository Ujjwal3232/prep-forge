    ...
    <div className="bg-slate-900 hover:bg-slate-800 transition border border-slate-800 rounded-md p-6">
      ...
      <form onSubmit={doPasswordChange}>
        <div className="grid grid-cols-1 gap-5">
          <div>
            <Label className="mb-2 block text-slate-300">Old password :</Label>
          ...
          <div>
            <Label className="mb-2 block text-slate-300">New password :</Label>
        ...
        <Button
          className="mt-5 bg-indigo-400 hover:bg-indigo-500 text-black"
          type="submit"
        >
          Save password
        </Button>
